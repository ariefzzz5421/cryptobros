...
const BRANDS = [
  ...
  { test: (host) => host === 'ansem.io' || host.endsWith('.ansem.io'), name: 'Ansem.io', logo: '/assets/img/platforms/ansem.ico' },
  { test: (host) => host === 'x.com' || host.endsWith('.x.com'), name: 'X', logo: '/assets/img/sources/x.svg', lightAsset: true },
  { test: (host) => host === 'opensea.io' || host.endsWith('.opensea.io'), name: 'OpenSea', logo: '/assets/img/sources/opensea.svg' },
  ...
  { test: (host) => host.includes('phemex.com'), name: 'Phemex', logo: '/assets/img/sources/phemex.png' },
  { test: (host) => host.includes('stonkbrokers.cash'), name: 'StonkBrokers', logo: '/assets/img/nft/stonkbrokers.png' },
  { test: (host) => host.includes('mancers.xyz'), name: 'Mancers', logo: '/assets/img/nft/mancers.png' },
  { test: (host) => host.includes('trololol.io'), name: 'TROLL', logo: '/assets/img/coins/troll.png' },
