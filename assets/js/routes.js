...
export const ROUTE_COLUMNS = [
  {
    ...
    routes: [
      ...
      },
      {
        ...
        label: 'Sentiment',
        labelId: 'Sentimen',
        note: 'Trading tools, chains, protocol activity',
        noteId: 'Alat trading, chain, dan aktivitas protokol',
      ...
      },
      {
        ...
        label: 'Launchpads',
        labelId: 'Launchpad',
        note: '30d fees and verified launched tokens',
        noteId: 'Fee 30 hari dan token launch terverifikasi',
        icon: 'M5 15 9 6l4-3 6 6-3 4-3-3-3 8zM7 17l-2 3M14 16l3 3',
      },
    ],
  },
  {
